...
console.log( "What a cute puppy!");
  ...
  console.log( "Sweet ol' yeller");
} else{
  console.log( "Thats a fine looking adult dog");
}
...
if (numQuarters <= 2) { // Write your conditional here
...
if ((cupsOfFlour >= 2) && (hasSauce === true)) {
  console.log( "I can make pizza");
   ...
   console.log( "I cannot make pizza"); // Write your conditional here
} else{
